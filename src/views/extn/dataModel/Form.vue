      ...
      <div class="main">
        ...
        <el-table v-loading="listLoading" :data="list" size='mini' ref="dragTable" row-key="index"
          ...
          <el-table-column label="操作" width="50">
            <template slot-scope="scope">
              <el-button class="OBPM-table-delBtn" size="mini" type="text"
...
import { DataModelInfo, DataModelUpdate, DataModelCreate, addTableFields } from '@/api/extn/dataModel'
import { getList } from '@/api/extn/commonFields'
export default {
  data() {
    return {
      dataForm: {
