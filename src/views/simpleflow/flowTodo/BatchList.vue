...
<script>
import { FlowBeforeList, getBatchFlowSelector, getBatchFlowJsonList, getNodeSelector, BatchCandidate, BatchOperation, RejectList } from '@/api/bpm/simpleflow/FlowBefore'
import ApproveDialog from '@/views/simpleflow/components/ApproveDialog'
