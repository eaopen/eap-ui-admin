...
<script>
import { noVModelList, calculateItem, onlinePeculiarList } from '@/components/extnGenerator/generator/comConfig'
import { inputComponents, selectComponents, systemComponents, layoutComponents } from '@/components/extnGenerator/generator/config'
import { isNumberStr } from '@/components/extnGenerator/utils'
import { saveFormConf, getDrawingList } from '@/components/extnGenerator/utils/db'
import { getDictionaryTypeSelector } from "@/api/extn/dictionary"
import { getDataInterfaceSelector } from "@/api/extn/dataInterface"
import { DataModelFieldList } from '@/api/extn/dataModel'
