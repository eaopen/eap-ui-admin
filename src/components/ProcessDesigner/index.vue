<template>
  <div class="process-design" :style="'display: flex; height:' + height">
    <bpmn-process-designer
      ...
      @save="onSaveProcess"
    />
    <bpmn-process-penal :bpmn-modeler="modeler" :prefix="controlForm.prefix" class="process-panel" />
  </div>
</template>
...
import { BpmnProcessDesigner, BpmnProcessPenal } from '@/plugins/package/index';
